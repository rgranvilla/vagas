...
var __decorateParam = (index2, decorator) => (target, key) =>
  decorator(target, key, index2);
    ...
    function printIteratorValues(
      ...
      if (!current.done) {
        ...
        while (!current.done) {
          result +=
            indentationNext +
            printer(current.value, config2, indentationNext, depth, refs);
          current = iterator.next();
          if (!current.done) {
            result += "," + config2.spacingInner;
          } else if (!config2.min) {
    ...
    var serialize2 = (val, config2, indentation, depth, refs, printer) => {
      ...
      if (
        ...
        return (
          stringedValue +
          SPACE +
          printer(val.sample, config2, indentation, depth, refs)
        );
      }
      if (
...
// node_modules/@vitest/utils/node_modules/pretty-format/build/plugins/ConvertAnsi.js
var require_ConvertAnsi = __commonJS({
  "node_modules/@vitest/utils/node_modules/pretty-format/build/plugins/ConvertAnsi.js"(
    ...
    exports.test = test3;
    var serialize2 = (val, config2, indentation, depth, refs, printer) =>
      printer(toHumanReadableAnsi(val), config2, indentation, depth, refs);
    exports.serialize = serialize2;
    var plugin2 = {
      serialize: serialize2,
      test: test3,
      ...
      children
        .map(
          (child) =>
            ...
            indentation +
            (typeof child === "string"
              ? printText(child, config2)
              : printer(child, config2, indentation, depth, refs))
        )
        .join("");
...
var require_DOMElement = __commonJS({
  "node_modules/@vitest/utils/node_modules/pretty-format/build/plugins/DOMElement.js"(
    ...
    var serialize2 = (node, config2, indentation, depth, refs, printer) => {
      ...
      const type2 = nodeIsFragment(node)
        ? "DocumentFragment"
  ...
  "node_modules/@vitest/utils/node_modules/pretty-format/build/plugins/Immutable.js"(
    ...
    var printImmutableEntries = (
      ...
      ++depth > config2.maxDepth
        ? printAsLeaf(getImmutableName(type2))
        : getImmutableName(type2) +
          SPACE +
          "{" +
...
// node_modules/@vitest/utils/node_modules/react-is/cjs/react-is.production.min.js
...
// node_modules/@vitest/utils/node_modules/react-is/cjs/react-is.development.js
      ...
      (function () {
        ...
        function isValidElementType(type2) {
          ...
          if (
            ...
            type2 === REACT_PROFILER_TYPE ||
            type2 === REACT_DEBUG_TRACING_MODE_TYPE ||
            type2 === REACT_STRICT_MODE_TYPE ||
            type2 === REACT_SUSPENSE_TYPE ||
            type2 === REACT_SUSPENSE_LIST_TYPE ||
            type2 === REACT_LEGACY_HIDDEN_TYPE ||
            enableScopeAPI
          ) {
            return true;
          }
          if (typeof type2 === "object" && type2 !== null) {
            if (
              type2.$$typeof === REACT_LAZY_TYPE ||
              type2.$$typeof === REACT_MEMO_TYPE ||
              type2.$$typeof === REACT_PROVIDER_TYPE ||
              type2.$$typeof === REACT_CONTEXT_TYPE ||
              type2.$$typeof === REACT_FORWARD_REF_TYPE ||
              type2.$$typeof === REACT_FUNDAMENTAL_TYPE ||
              type2.$$typeof === REACT_BLOCK_TYPE ||
              type2[0] === REACT_SERVER_BLOCK_TYPE
            ) {
              return true;
            }
          }
...
// node_modules/@vitest/utils/node_modules/react-is/index.js
...
var require_ReactElement = __commonJS({
  "node_modules/@vitest/utils/node_modules/pretty-format/build/plugins/ReactElement.js"(
    ...
    var getType2 = (element) => {
      ...
      if (typeof type2 === "object" && type2 !== null) {
        ...
        if (ReactIs.isForwardRef(element)) {
          ...
          const functionName3 =
            type2.render.displayName || type2.render.name || "";
          return functionName3 !== ""
            ? "ForwardRef(" + functionName3 + ")"
            : "ForwardRef";
        }
        if (ReactIs.isMemo(element)) {
          const functionName3 =
            type2.displayName ||
            type2.type.displayName ||
            type2.type.name ||
            "";
    ...
    var serialize2 = (element, config2, indentation, depth, refs, printer) =>
      ++depth > config2.maxDepth
        ? (0, _markup.printElementAsLeaf)(getType2(element), config2)
...
var require_ReactTestComponent = __commonJS({
  "node_modules/@vitest/utils/node_modules/pretty-format/build/plugins/ReactTestComponent.js"(
    ...
    var serialize2 = (object2, config2, indentation, depth, refs, printer) =>
      ++depth > config2.maxDepth
        ? (0, _markup.printElementAsLeaf)(object2.type, config2)
        : (0, _markup.printElement)(
            object2.type,
            object2.props
              ? (0, _markup.printProps)(
...
var require_build = __commonJS({
  "node_modules/@vitest/utils/node_modules/pretty-format/build/index.js"(
    ...
    function printComplexValue(
      ...
      if (isToStringedArrayType(toStringed)) {
        return hitMaxDepth
          ...
          : (min
              ? ""
              : !config2.printBasicPrototype && val.constructor.name === "Array"
              ? ""
              : val.constructor.name + " ") +
              "[" +
              (0, _collections.printListItems)(
    ...
    function printPlugin(plugin2, val, config2, indentation, depth, refs) {
      let printed;
      try {
        printed = isNewPlugin(plugin2)
          ? plugin2.serialize(val, config2, indentation, depth, refs, printer)
          : plugin2.print(
              val,
              (valChild) =>
                printer(valChild, config2, indentation, depth, refs),
              (str) => {
                const indentationNext = indentation + config2.indent;
                return (
                  indentationNext +
...
function inspectList(list, options, inspectItem, separator = ", ") {
  ...
  for (let i2 = 0; i2 < size; i2 += 1) {
    ...
    peek = last
      ? ""
      : inspectItem(list[i2 + 1], options) + (secondToLast ? "" : separator);
    if (
      !last &&
      secondToLast &&
...
function inspectTypedArray(array2, options) {
  ...
  for (let i2 = 0; i2 < array2.length; i2++) {
    const string3 = `${options.stylize(
      truncate(array2[i2], options.truncate),
      "number"
    )}${i2 === array2.length - 1 ? "" : ", "}`;
...
function inspectString(string3, options) {
  ...
  return options.stylize(
    `'${truncate(string3, options.truncate - 2)}'`,
    "string"
  );
}
...
var init_promise = __esm({
  "node_modules/loupe/lib/promise.js"() {
    ...
    try {
      const { getPromiseDetails, kPending, kRejected } =
...
function inspectAttribute([key, value], options) {
  ...
  return `${options.stylize(key, "yellow")}=${options.stylize(
    `"${value}"`,
    "string"
  )}`;
}
  ...
  "node_modules/concordance/lib/Circular.js"(exports, module2) {
    ...
    var Circular = class {
      ...
      add(descriptor) {
        ...
        if (
          descriptor.isItem !== true &&
          descriptor.isMapEntry !== true &&
    ...
    var Line = class {
      ...
      *[Symbol.iterator]() {
      ...
      toString(options) {
        ...
        return (
          translateGutter(options.theme, options.invert, this.gutter) +
          this.stringValue
        );
      }
      mergeWithInfix(infix, other) {
        ...
        return new Line(
          ...
          other.isLast,
          other.gutter,
          this.stringValue + infix + other.stringValue
        );
      }
      ...
      *[Symbol.iterator]() {
      ...
      mergeWithInfix(infix, from) {
        ...
        for (const line of this) {
          if (seenLast)
            throw new Error(
              "Cannot merge line, the last line has already been seen."
            );
          if (!line.isLast) {
            merged.append(line);
            continue;
      ...
      withFirstPrefixed(prefix) {
        return new Collection().append(
          Array.from(this, (line) => line.withFirstPrefixed(prefix))
        );
      }
      withLastPostfixed(postfix) {
        return new Collection().append(
          Array.from(this, (line) => line.withLastPostfixed(postfix))
        );
      }
      stripFlags() {
        return new Collection().append(
          Array.from(this, (line) => line.stripFlags())
        );
      }
      decompose() {
...
var require_formatUtils = __commonJS({
  "node_modules/concordance/lib/formatUtils.js"(exports) {
    ...
    function formatCtorAndStringTag(theme, object2) {
      if (!object2.ctor) return wrap(theme.object.stringTag, object2.stringTag);
      let retval = wrap(theme.object.ctor, object2.ctor);
      if (
        object2.stringTag &&
        object2.stringTag !== object2.ctor &&
        object2.stringTag !== "Object"
      ) {
        retval +=
          " " + wrap(theme.object.secondaryStringTag, object2.stringTag);
      }
      return retval;
    }
    ...
    var ObjectFormatter = class {
      ...
      finalize() {
        ...
        const prefix =
          (ctor === "Array" || ctor === "Object") && ctor === stringTag
            ? ""
            : formatCtorAndStringTag(this.theme, this.object) + " ";
        if (this.innerLines.isEmpty) {
          return lineBuilder.single(
            prefix + variant.openBracket + variant.closeBracket
          );
        }
        return lineBuilder
          .first(prefix + variant.openBracket)
          .concat(
            this.innerLines
              .withFirstPrefixed(this.indent.increase())
              .stripFlags()
          )
    ...
    var SingleValueFormatter = class {
      ...
      append(formatted) {
        if (this.hasValue)
          throw new Error(
            "Formatter buffer can only take one formatted value."
          );
        this.hasValue = true;
      ...
      for (const name of nameCandidates) {
        ...
        if (excludeListItemAccessorsBelowLength > 0) {
          ...
          accept =
            ...
            index2 < 0 ||
            index2 >= excludeListItemAccessorsBelowLength;
        }
      ...
      prepareDiff(expected, lhsRecursor, rhsRecursor, compareComplexShape) {
        ...
        if (actual !== null && extraneous.length > 0) {
          return {
            ...
            rhsRecursor: recursorUtils.unshift(
              rhsFork.recursor,
              initialExpected
            ),
          };
...
var require_object = __commonJS({
  "node_modules/concordance/lib/complexValues/object.js"(exports) {
    ...
    function describe2(props) {
      ...
      return new DescribedObjectValue(
        Object.assign(
          {
            isArray,
    ...
    var ObjectValue = class {
      ...
      compare(expected) {
        ...
        if (
          this.stringTag !== expected.stringTag ||
          !this.hasSameCtor(expected)
        )
          return UNEQUAL;
        ...
        createListRecursor() {
          ...
          const next = () => {
            ...
            return this.describeItem(
              current,
              this.describeAny(this.value[current])
            );
          };
          return { size, next };
        }
        ...
        createRecursor() {
          ...
          return () => {
            ...
            do {
              ...
              while (
                recursor === null &&
                (!recursedList || !recursedProperty || !recursedIterable)
              ) {
                if (!recursedList) {
                  const replay = recursorUtils.replay(this.listState, () =>
                    this.createListRecursor()
                  );
                  ...
                  const replay = recursorUtils.replay(this.propertyState, () =>
                    this.createPropertyRecursor()
                  );
                  ...
                  const replay = recursorUtils.replay(this.iterableState, () =>
                    this.createIterableRecursor()
                  );
    ...
    function DeserializedMixin(base) {
      return class extends base {
        ...
        createRecursor() {
          ...
          const replay = recursorUtils.replay(this.replayState, () => ({
            size: -1,
            next: this.deserializedRecursor,
          }));
...
var require_arguments = __commonJS({
  "node_modules/concordance/lib/complexValues/arguments.js"(exports) {
    ...
    var UNEQUAL = constants.UNEQUAL;
    function describe2(props) {
      return new DescribedArgumentsValue(
        Object.assign(
          {
    ...
    var DeserializedArgumentsValue = class extends object2.DeserializedMixin(
      ArgumentsValue
    ) {
      compare(expected) {
    ...
    var Bytes = class {
      ...
      formatDeep(theme, indent) {
        ...
        for (let offset = 0; offset < this.buffer.length; offset += 4) {
          ...
          string3 += formatUtils.wrap(
            theme.typedArray.bytes,
            this.buffer.toString("hex", offset, offset + 4)
          );
        }
        return isFirst
          ? lineBuilder.single(string3)
          : lines.append(lineBuilder.last(string3));
      }
      serialize() {
        return this.buffer;
      }
      ...
      return class extends object2.DescribedMixin(base) {
        ...
        createPropertyRecursor() {
          ...
          const next = () => {
            ...
            return this.describeProperty(
              "byteLength",
              this.describeAny(this.buffer.byteLength)
            );
          };
          return { size, next };
        }
        createRecursor() {
          return recursorUtils.unshift(
            super.createRecursor(),
            new Bytes(this.buffer)
          );
        }
      };
    }
...
var require_arrayBuffer = __commonJS({
  "node_modules/concordance/lib/complexValues/arrayBuffer.js"(exports) {
    ...
    function describe2(props) {
      return new DescribedArrayBufferValue(
        Object.assign(
          {
    ...
    var DeserializedArrayBufferValue =
      typedArray.DeserializedMixin(ArrayBufferValue);
  },
});
...
var require_string = __commonJS({
  "node_modules/concordance/lib/primitiveValues/string.js"(exports) {
    ...
    var MATCH_CONTROL_PICTURES = new RegExp(
      `${CR_CONTROL_PICTURE}|${LF_CONTROL_PICTURE}|${CR_CONTROL_PICTURE}`,
      "g"
    );
    function escapeLinebreak(string3) {
      if (string3 === "\r\n") return CRLF_CONTROL_PICTURE;
      if (string3 === "\n") return LF_CONTROL_PICTURE;
      if (string3 === "\r") return CR_CONTROL_PICTURE;
      return string3;
    }
    function themeControlPictures(theme, resetWrap, str) {
      return str.replace(MATCH_CONTROL_PICTURES, (picture) => {
        return (
          resetWrap.close +
          formatUtils.wrap(theme.string.controlPicture, picture) +
          resetWrap.open
        );
      });
    }
    ...
    function escapeQuotes(line, string3) {
      ...
      if (quote === "'") return string3.replace(MATCH_SINGLE_QUOTE, "\\'");
      if (quote === '"') return string3.replace(MATCH_DOUBLE_QUOTE, '\\"');
      if (quote === "`") return string3.replace(MATCH_BACKTICKS, "\\`");
      return string3;
    }
    ...
    function diffLine(theme, actual, expected, invert) {
      ...
      const isPartiallyEqual = !(
        (outcome.length === 2 &&
          outcome[0][1] === actual &&
          outcome[1][1] === expected) || // Discount line ending control pictures, which will be equal even when the
      ...
      for (const diff2 of outcome) {
        if (diff2[0] === fastDiff.DELETE) {
          ...
          const string3 = formatUtils.wrap(
            equalWrap,
            themeControlPictures(theme, equalWrap, diff2[1])
          );
      ...
      if (!isPartiallyEqual) {
        const deleteLineWrap = invert
          ? theme.string.diff.insertLine
          : theme.string.diff.deleteLine;
        const insertLineWrap = invert
          ? theme.string.diff.deleteLine
          : theme.string.diff.insertLine;
    ...
    function gatherLines(string3) {
      ...
      for (
        let match;
        (match = LINEBREAKS.exec(string3));
        prevIndex = match.index + match[0].length
      ) {
        lines.push(
          string3.slice(prevIndex, match.index) + escapeLinebreak(match[0])
        );
      }
    ...
    var StringValue = class {
      ...
      formatDeep(theme, indent) {
        ...
        if (!this.includesLinebreaks) {
          ...
          return lineBuilder.single(
            formatUtils.wrap(
              theme.string.line,
              formatUtils.wrap(theme.string, escaped)
            )
          );
        }
        ...
        const lineStrings = gatherLines(escaped).map((string3) => {
          return formatUtils.wrap(
            theme.string,
            themeControlPictures(theme, theme.string, string3)
          );
        });
        ...
        return lineBuilder.buffer().append(
          lineStrings.map((string3, index2) => {
            ...
            if (index2 === lastIndex)
              return lineBuilder.last(
                indentation + string3 + theme.string.multiline.end
              );
      ...
      formatAsKey(theme) {
        ...
        if (
          keyword.isIdentifierNameES6(key, true) ||
      ...
      diffDeep(expected, theme, indent, invert) {
        ...
        if (
          !includesLinebreaks(escapedActual) &&
          !includesLinebreaks(escapedExpected)
        ) {
          ...
          return lineBuilder.actual
            .single(formatUtils.wrap(theme.string.line, result[0]))
            .concat(
              lineBuilder.expected.single(
                formatUtils.wrap(theme.string.line, result[1])
              )
            );
        }
        const actualLines = gatherLines(
          escapeQuotes(theme.string.multiline, escapedActual)
        );
        const expectedLines = gatherLines(
          escapeQuotes(theme.string.multiline, escapedExpected)
        );
        const indentation = indent;
        const lines = lineBuilder.buffer();
        ...
        for (
          let actualIndex = 0, expectedIndex = 0, extraneousOffset = 0;
          ...
          if (actualLines[actualIndex] === expectedLines[expectedIndex]) {
            ...
            if (actualIndex === 0) {
              lines.append(
                lineBuilder.first(theme.string.multiline.start + string3)
              );
            } else if (
          ...
          let expectedIsMissing = false;
          {
            ...
            for (
              let index2 = expectedIndex;
              !expectedIsMissing && index2 < expectedLines.length;
              index2++
            ) {
              expectedIsMissing = compare === expectedLines[index2];
            }
          }
          let actualIsExtraneous =
            actualIndex - extraneousOffset > lastExpectedIndex ||
            expectedIndex > lastExpectedIndex;
          if (!actualIsExtraneous) {
            const compare = expectedLines[expectedIndex];
            for (
              let index2 = actualIndex;
              !actualIsExtraneous && index2 < actualLines.length;
              index2++
            ) {
          ...
          if (actualIsExtraneous && !expectedIsMissing) {
            ...
            if (actualIndex === 0) {
              actualBuffer.push(
                lineBuilder.actual.first(theme.string.multiline.start + string3)
              );
              mustOpenNextExpected = true;
            } else if (actualIndex === lastActualIndex) {
              actualBuffer.push(
                lineBuilder.actual.last(
                  indentation + string3 + theme.string.multiline.end
                )
              );
            } else {
            ...
            if (mustOpenNextExpected) {
              expectedBuffer.push(
                lineBuilder.expected.first(
                  theme.string.multiline.start + string3
                )
              );
              mustOpenNextExpected = false;
            } else if (expectedIndex === lastExpectedIndex) {
              expectedBuffer.push(
                lineBuilder.expected.last(
                  indentation + string3 + theme.string.multiline.end
                )
              );
            } else {
              expectedBuffer.push(
                lineBuilder.expected.line(indentation + string3)
              );
            }
            expectedIndex++;
          } else {
            ...
            if (actualIndex === 0) {
              actualBuffer.push(
                lineBuilder.actual.first(
                  theme.string.multiline.start + result[0]
                )
              );
              mustOpenNextExpected = true;
            } else if (actualIndex === lastActualIndex) {
              actualBuffer.push(
                lineBuilder.actual.last(
                  indentation + result[0] + theme.string.multiline.end
                )
              );
            } else {
              actualBuffer.push(
                lineBuilder.actual.line(indentation + result[0])
              );
            }
            if (mustOpenNextExpected) {
              expectedBuffer.push(
                lineBuilder.expected.first(
                  theme.string.multiline.start + result[1]
                )
              );
              mustOpenNextExpected = false;
            } else if (expectedIndex === lastExpectedIndex) {
              expectedBuffer.push(
                lineBuilder.expected.last(
                  indentation + result[1] + theme.string.multiline.end
                )
              );
            } else {
              expectedBuffer.push(
                lineBuilder.expected.line(indentation + result[1])
              );
            }
            actualIndex++;
            expectedIndex++;
  ...
  "node_modules/concordance/lib/complexValues/date.js"(exports) {
    ...
    var DateValue = class extends object2.ObjectValue {
      ...
      compare(expected) {
        ...
        return (this.invalid && expected.invalid) ||
          Object.is(this.value.getTime(), expected.value.getTime())
          ? SHALLOW_EQUAL
          : UNEQUAL;
      }
      formatShallow(theme, indent) {
        ...
        return super.formatShallow(theme, indent).customize({
          finalize(innerLines) {
            return innerLines.isEmpty
              ? lineBuilder.single(string3 + theme.object.closeBracket)
              : lineBuilder
                  .first(string3)
                  .concat(
                    innerLines.withFirstPrefixed(indent.increase()).stripFlags()
                  )
                  .append(lineBuilder.last(indent + theme.object.closeBracket));
          },
          maxDepth() {
            return lineBuilder.single(
              string3 + " " + theme.maxDepth + " " + theme.object.closeBracket
            );
          },
        });
      }
    ...
    var DeserializedDateValue = class extends object2.DeserializedMixin(
      DateValue
    ) {
      constructor(state, recursor) {
  ...
  "node_modules/concordance/lib/complexValues/error.js"(exports) {
    ...
    var ErrorValue = class extends object2.ObjectValue {
      ...
      formatShallow(theme, indent) {
        ...
        if (
          this.stringTag &&
          this.stringTag !== this.ctor &&
          this.name &&
          !this.name.includes(this.stringTag)
        ) {
          string3 +=
            " " +
            formatUtils.wrap(theme.object.secondaryStringTag, this.stringTag);
        }
    ...
    var DeserializedErrorValue = class extends object2.DeserializedMixin(
      ErrorValue
    ) {
      constructor(state, recursor) {
...
var require_function = __commonJS({
  "node_modules/concordance/lib/complexValues/function.js"(exports) {
    ...
    var FunctionValue = class extends object2.ObjectValue {
      ...
      formatShallow(theme, indent) {
        const string3 =
          formatUtils.wrap(theme.function.stringTag, this.stringTag) +
          (this.name
            ? " " + formatUtils.wrap(theme.function.name, this.name)
            : "") +
          " " +
          theme.object.openBracket;
        return super.formatShallow(theme, indent).customize({
    ...
    var DescribedFunctionValue = class extends object2.DescribedMixin(
      FunctionValue
    ) {
      constructor(props) {
        super(props);
    ...
    var DeserializedFunctionValue = class extends object2.DeserializedMixin(
      FunctionValue
    ) {
      constructor(state, recursor) {
        super(state[1], recursor);
...
var require_global = __commonJS({
  "node_modules/concordance/lib/complexValues/global.js"(exports) {
    ...
    var GlobalValue = class {
      ...
      formatDeep(theme) {
        return lineBuilder.single(
          formatUtils.wrap(theme.global, "Global") +
            " " +
            theme.object.openBracket +
    ...
    var DescribedMapValue = class extends object2.DescribedMixin(MapValue) {
      createIterableRecursor() {
        ...
        const next = () => {
          ...
          return this.describeMapEntry(
            this.describeAny(entry[0]),
            this.describeAny(entry[1])
          );
        };
        return { size, next };
      }
    };
    var DeserializedMapValue = class extends object2.DeserializedMixin(
      MapValue
    ) {
      constructor(state, recursor) {
        super(state[1], recursor);
...
var require_promise = __commonJS({
  "node_modules/concordance/lib/complexValues/promise.js"(exports) {
    ...
    var DescribedPromiseValue = class extends object2.DescribedMixin(
      PromiseValue
    ) {
      compare(expected) {
    ...
    var DeserializedPromiseValue = class extends object2.DeserializedMixin(
      PromiseValue
    ) {
      compare(expected) {
        return super.compare(expected);
...
var require_regexp = __commonJS({
  "node_modules/concordance/lib/complexValues/regexp.js"(exports) {
    ...
    function describe2(props) {
      ...
      return new DescribedRegexpValue(
        Object.assign(
          {
    ...
    function getSortedFlags(regexp) {
      const flags =
        regexp.flags || String(regexp).slice(regexp.source.length + 2);
    ...
    var RegexpValue = class extends object2.ObjectValue {
      ...
      compare(expected) {
        return this.tag === expected.tag &&
          this.flags === expected.flags &&
          this.source === expected.source
          ? super.compare(expected)
          : UNEQUAL;
      }
      formatShallow(theme, indent) {
        ...
        const regexp =
          formatUtils.wrap(theme.regexp.source, this.source) +
          formatUtils.wrap(theme.regexp.flags, this.flags);
        return super.formatShallow(theme, indent).customize({
          finalize: (innerLines) => {
            if (ctor === "RegExp" && innerLines.isEmpty)
              return lineBuilder.single(regexp);
            const innerIndentation = indent.increase();
            const header = lineBuilder
              .first(
                formatUtils.formatCtorAndStringTag(theme, this) +
                  " " +
                  theme.object.openBracket
            ...
            if (!innerLines.isEmpty) {
              header.append(
                lineBuilder.line(innerIndentation + theme.regexp.separator)
              );
              header.append(
                innerLines.withFirstPrefixed(innerIndentation).stripFlags()
              );
            }
            return header.append(
              lineBuilder.last(indent + theme.object.closeBracket)
            );
          },
          maxDepth: () => {
            return lineBuilder.single(
    ...
    var DeserializedRegexpValue = class extends object2.DeserializedMixin(
      RegexpValue
    ) {
      constructor(state, recursor) {
        super(state[2], recursor);
...
var require_set = __commonJS({
  "node_modules/concordance/lib/complexValues/set.js"(exports) {
    ...
    var DeserializedSetValue = class extends object2.DeserializedMixin(
      SetValue
    ) {
      constructor(state, recursor) {
        super(state[1], recursor);
  ...
  "node_modules/concordance/lib/metaDescriptors/item.js"(exports) {
    ...
    var ComplexItem = class {
      ...
      formatShallow(theme, indent) {
        ...
        return new formatUtils.SingleValueFormatter(
          theme,
          (value) => {
      ...
      prepareDiff(
        ...
        while (
          !expectedIsMissing &&
          expected !== null &&
          expected.isItem === true
        ) {
          if (expected.tag === complexTag) {
            expectedIsMissing =
              compareComplexShape(this.value, expected.value) !== UNEQUAL;
          }
          expected = rhsFork.shared();
        }
        ...
        if (initialExpected.tag === complexTag) {
          ...
          while (
            ...
            if (actual.tag === complexTag) {
              actualIsExtraneous =
                compareComplexShape(actual.value, initialExpected.value) !==
                UNEQUAL;
            }
            actual = lhsFork.shared();
          }
          ...
          while (
            ...
            if (actual.tag === primitiveTag) {
              actualIsExtraneous =
                initialExpected.value.compare(actual.value) === DEEP_EQUAL;
            }
            actual = lhsFork.shared();
          }
        }
        ...
        const mustRecurse =
          this.tag === complexTag &&
          initialExpected.tag === complexTag &&
    ...
    var PrimitiveItem = class {
      ...
      prepareDiff(
        ...
        if (
          ...
          this.value.tag === expected.value.tag &&
      ...
      diffDeep(expected, theme, indent, invert) {
        if (
          this.tag !== expected.tag ||
          typeof this.value.diffDeep !== "function"
        )
          return null;
        const increaseValueIndent = theme.property.increaseValueIndent === true;
        const valueIndent = increaseValueIndent ? indent.increase() : indent;
        const diff2 = this.value.diffDeep(
          expected.value,
          theme,
          valueIndent,
          invert
        );
        if (diff2 === null) return null;
        if (typeof theme.item.customFormat === "function") {
...
var require_assignValue = __commonJS({
  "node_modules/lodash/_assignValue.js"(exports, module2) {
    ...
    function assignValue(object2, key, value) {
      ...
      if (
        !(hasOwnProperty.call(object2, key) && eq2(objValue, value)) ||
...
var require_isIndex = __commonJS({
  "node_modules/lodash/_isIndex.js"(exports, module2) {
    ...
    function isIndex(value, length) {
      ...
      return (
        !!length &&
        (type2 == "number" || (type2 != "symbol" && reIsUint.test(value))) &&
        value > -1 &&
        value % 1 == 0 &&
        value < length
      );
    ...
    function baseKeysIn(object2) {
      ...
      for (var key in object2) {
        if (
          !(
            key == "constructor" &&
            (isProto || !hasOwnProperty.call(object2, key))
          )
        ) {
          result.push(key);
        }
    ...
    function isIterateeCall(value, index2, object2) {
      ...
      if (
        type2 == "number"
          ...
          : type2 == "string" && index2 in object2
      ) {
...
var require_compare = __commonJS({
  "node_modules/concordance/node_modules/semver/functions/compare.js"(
    ...
    var SemVer = require_semver();
    var compare = (a, b2, loose) =>
      new SemVer(a, loose).compare(new SemVer(b2, loose));
...
var require_sort = __commonJS({
  "node_modules/concordance/node_modules/semver/functions/sort.js"(
    ...
    var sort2 = (list, loose) =>
      list.sort((a, b2) => compareBuild(a, b2, loose));
...
var require_rsort = __commonJS({
  "node_modules/concordance/node_modules/semver/functions/rsort.js"(
    ...
    var compareBuild = require_compare_build();
    var rsort = (list, loose) =>
      list.sort((a, b2) => compareBuild(b2, a, loose));
...
var require_yallist = __commonJS({
  "node_modules/yallist/yallist.js"(exports, module2) {
    ...
    Yallist.prototype.forEachReverse = function (fn2, thisp) {
      thisp = thisp || this;
      for (
        var walker = this.tail, i2 = this.length - 1;
        walker !== null;
        i2--
      ) {
        fn2.call(thisp, walker.value, i2, this);
    ...
    Yallist.prototype.sliceReverse = function (from, to) {
      ...
      for (
        var i2 = this.length, walker = this.tail;
        walker !== null && i2 > to;
        i2--
      ) {
        walker = walker.prev;
    ...
    Yallist.prototype.splice = function (start, deleteCount, ...nodes) {
      ...
      for (
        var i2 = 0, walker = this.head;
        walker !== null && i2 < start;
        i2++
      ) {
        walker = walker.next;
      }
...
var require_lru_cache = __commonJS({
  "node_modules/lru-cache/index.js"(exports, module2) {
    ...
    var isStale = (self2, hit) => {
      ...
      return hit.maxAge
        ? diff2 > hit.maxAge
        : self2[MAX_AGE] && diff2 > self2[MAX_AGE];
    };
    var trim = (self2) => {
...
var require_symbol = __commonJS({
  "node_modules/concordance/lib/primitiveValues/symbol.js"(exports) {
    ...
    var SymbolValue = class {
      ...
      formatDeep(theme) {
        return lineBuilder.single(
          formatUtils.wrap(theme.symbol, this.formatString())
        );
      }
      formatAsKey(theme) {
        return formatUtils.wrap(
          theme.property.keyBracket,
          formatUtils.wrap(theme.symbol, this.formatString())
        );
      }
      serialize() {
        const string3 = this.formatString();
        return this.stringCompare === string3
          ? [this.stringCompare]
    ...
    var Property = class {
      ...
      compareKeys(expected) {
        ...
        return result === UNEQUAL &&
          this.key.tag === symbolPrimitive &&
          expected.key.tag === symbolPrimitive
          ? AMBIGUOUS
          : result;
      }
      prepareDiff(
        ...
        return new formatUtils.SingleValueFormatter(
          ...
          (value) => {
            if (typeof theme.property.customFormat === "function") {
              return theme.property.customFormat(
                theme,
                indent,
                this.key,
                value
            ...
            return value
              .withFirstPrefixed(
                this.key.formatAsKey(theme) + theme.property.separator
              )
  ...
  "node_modules/concordance/lib/pluginRegistry.js"(exports) {
    ...
    var DuplicateDescriptorTagError = class extends PluginError {
      constructor(tag, plugin2) {
        super(
          `Could not add descriptor: tag ${String(
            tag
      ...
      constructor(id, plugin2) {
        const printed =
          typeof id === "number"
            ...
            : String(id);
        super(
          `Could not add descriptor: id ${printed} has already been registered`,
          plugin2
        );
      ...
      if ("minimalConcordanceVersion" in plugin2) {
        if (!semver.valid(plugin2.minimalConcordanceVersion)) {
          throw new PluginTypeError(
            "If specified, `minimalConcordanceVersion` must be a valid SemVer version",
            plugin2
          );
        }
...
var require_themeUtils = __commonJS({
  "node_modules/concordance/lib/themeUtils.js"(exports) {
    ...
    function normalizePlugins(plugins3) {
      if (!Array.isArray(plugins3) || plugins3.length === 0) return null;
      const refs = [];
      const themes = [];
    ...
    function normalize2(options) {
      ...
      const entry = normalizedCache.get(options.theme) || {
        theme: null,
        withPlugins: /* @__PURE__ */ new Map(),
      };
      ...
      if (normalizedPlugins) {
        ...
        const theme = freezeTheme(
          merge(cloneDeep(normalizedPlugins.theme), options.theme)
        );
        entry.withPlugins.set(normalizedPlugins.ref, theme);
        return theme;
      }
      if (!entry.theme) {
        entry.theme = freezeTheme(
          merge(cloneDeep(defaultTheme), options.theme)
        );
      }
      return entry.theme;
    }
    ...
    function applyModifiers(descriptor, theme) {
      ...
      return Array.from(modifiers.get(descriptor)).reduce((prev, modifier) => {
        const cache2 =
          modifierCache.get(modifier) || /* @__PURE__ */ new WeakMap();
        if (!modifierCache.has(modifier)) modifierCache.set(modifier, cache2);
        if (cache2.has(prev)) return cache2.get(prev);
  ...
  "node_modules/concordance/lib/metaDescriptors/mapEntry.js"(exports) {
    ...
    function mergeWithKey(theme, key, values) {
      ...
      for (const value of values) {
        lines.append(
          keyRemainder
            .mergeWithInfix(theme.mapEntry.separator, value)
            .withLastPostfixed(theme.mapEntry.after)
        );
      }
      return lines;
    }
    var MapEntry = class {
      ...
      formatDeep(theme, indent) {
        if (!this.keyIsPrimitive || typeof this.value.formatDeep !== "function")
          return null;
        const value = this.value.formatDeep(
          themeUtils.applyModifiersToOriginal(this.value, theme),
          indent
        );
        if (value === null) return null;
        const key = this.key.formatDeep(
          themeUtils.applyModifiersToOriginal(this.key, theme),
          indent
        );
      ...
      diffDeep(expected, theme, indent, invert) {
        ...
        if (
          !this.keyIsPrimitive ||
          !expected.keyIsPrimitive ||
          this.key.compare(expected.key) !== DEEP_EQUAL
        ) {
          return null;
        }
        const diff2 = this.value.diffDeep(
      ...
      prepareDiff(
        ...
        while (
          ...
          if (expected.keyIsPrimitive) {
            ...
            expectedIsMissing =
              compareComplexShape(this.key, expected.key) !== UNEQUAL;
          }
          expected = rhsFork.shared();
        }
        let actualIsExtraneous = false;
          ...
          if (initialExpected.keyIsPrimitive) {
            ...
            while (
              ...
              if (actual.keyIsPrimitive) {
                actualIsExtraneous =
                  initialExpected.key.compare(actual.key) === DEEP_EQUAL;
              }
              actual = lhsFork.shared();
            }
          } else {
            ...
            while (
              ...
              if (!actual.keyIsPrimitive) {
                actualIsExtraneous =
                  compareComplexShape(actual.key, initialExpected.key) !==
                  UNEQUAL;
              }
              actual = lhsFork.shared();
            }
        ...
        if (!this.keyIsPrimitive && !initialExpected.keyIsPrimitive) {
          if (this.valueIsPrimitive || initialExpected.valueIsPrimitive) {
            ...
            mustRecurse =
              compareComplexShape(this.value, initialExpected.value) !==
              UNEQUAL;
          }
        }
        return {
...
var require_bigInt = __commonJS({
  "node_modules/concordance/lib/primitiveValues/bigInt.js"(exports) {
    ...
    var BigIntValue = class {
      ...
      formatDeep(theme) {
        return lineBuilder.single(
          formatUtils.wrap(theme.bigInt, `${this.value}n`)
        );
      }
      serialize() {
        return this.value;
    ...
    Object.defineProperty(BigIntValue.prototype, "isPrimitive", {
      value: true,
    });
...
var require_boolean = __commonJS({
  "node_modules/concordance/lib/primitiveValues/boolean.js"(exports) {
    ...
    Object.defineProperty(BooleanValue.prototype, "isPrimitive", {
      value: true,
    });
...
var require_undefined = __commonJS({
  "node_modules/concordance/lib/primitiveValues/undefined.js"(exports) {
    ...
    var UndefinedValue = class {
      ...
      formatDeep(theme) {
        return lineBuilder.single(
          formatUtils.wrap(theme.undefined, "undefined")
        );
      }
    };
...
var require_describe = __commonJS({
  "node_modules/concordance/lib/describe.js"(exports, module2) {
    ...
    function describePrimitive(value) {
      ...
      if (value === void 0) return undefinedValue.describe();
      if (value === true || value === false)
        return booleanValue.describe(value);
      const type2 = typeof value;
      if (type2 === "bigint") return bigIntValue.describe(value);
      if (type2 === "number") return numberValue.describe(value);
      if (type2 === "string") return stringValue.describe(value);
      if (type2 === "symbol") return symbolValue.describe(value);
      return null;
    }
    ...
    var describeItem = (index2, valueDescriptor) => {
      return valueDescriptor.isPrimitive === true
        ? itemDescriptor.describePrimitive(index2, valueDescriptor)
        : itemDescriptor.describeComplex(index2, valueDescriptor);
    };
  ...
  "node_modules/concordance/lib/compare.js"(exports) {
    ...
    function shortcircuitPrimitive(value) {
      if (
        ...
        return true;
      const type2 = typeof value;
      if (type2 === "string" || type2 === "symbol") return true;
      if (type2 === "number") return !isNaN(value);
      return false;
    }
    function compareDescriptors(lhs, rhs) {
      ...
      do {
        ...
        if (lhsCircular.has(lhs)) {
          result =
            lhsCircular.get(lhs) === rhsCircular.get(rhs)
              ? DEEP_EQUAL
              : UNEQUAL;
        ...
        if (result !== DEEP_EQUAL) {
          ...
          if (result === AMBIGUOUS && lhs.isProperty === true) {
            lhs = new symbolProperties.Collector(
              lhs,
              lhsStack[topIndex].recursor
            );
            rhs = new symbolProperties.Collector(
              rhs,
              rhsStack[topIndex].recursor
            );
            lhsStack[topIndex].recursor = recursorUtils.unshift(
              lhsStack[topIndex].recursor,
              lhs.collectAll()
            );
            rhsStack[topIndex].recursor = recursorUtils.unshift(
              rhsStack[topIndex].recursor,
              rhs.collectAll()
            );
          }
...
var require_diff3 = __commonJS({
  "node_modules/concordance/lib/diff.js"(exports) {
    ...
    function diffDescriptors2(lhs, rhs, options) {
      ...
      const diffStack = [];
      let diffIndex = -1;
      const isCircular = (descriptor) =>
        lhsCircular.has(descriptor) || rhsCircular.has(descriptor);
      const format4 = (builder, subject, circular, depthOffset = 0) => {
        ...
        do {
          if (circular.has(subject)) {
            formatStack[formatIndex].formatter.append(
              builder.single(theme.circular),
              subject
            );
          } else {
            let didFormat = false;
            if (typeof subject.formatDeep === "function") {
              let formatted = subject.formatDeep(
                themeUtils.applyModifiers(subject, theme),
                indent
              );
              if (formatted !== null) {
                didFormat = true;
            ...
            if (!didFormat && typeof subject.formatShallow === "function") {
              const formatter = subject.formatShallow(
                themeUtils.applyModifiers(subject, theme),
                indent
              );
              ...
              if (
                ...
                maxDepth > 0 &&
                indent.level === maxDepth + depthOffset
              ) {
                const isEmpty = recursor() === null;
                let formatted =
                  !isEmpty && typeof formatter.maxDepth === "function"
                    ? formatter.maxDepth()
                    : formatter.finalize();
                if (formatIndex === -1) {
                  formatted = builder.setDefaultGutter(formatted);
          ...
          while (formatIndex >= 0) {
            do {
              ...
              subject &&
              !formatStack[formatIndex].shouldFormat(subject)
            );
            if (subject) {
              break;
            }
            ...
            if (formatIndex === -1) {
              ...
              if (diffIndex === -1) {
                ...
                diffStack[diffIndex].formatter.append(
                  formatted,
                  record.subject
                );
              }
      ...
      do {
        ...
        if (lhs.isProperty === true) {
          ...
          if (compareResult === AMBIGUOUS) {
            ...
            firstPassSymbolProperty =
              parent.isSymbolPropertiesCollector !== true &&
              parent.isSymbolPropertiesComparable !== true;
          }
        }
        let didFormat = false;
        let mustRecurse = false;
        if (
          compareResult !== DEEP_EQUAL &&
          !firstPassSymbolProperty &&
          typeof lhs.prepareDiff === "function"
        ) {
          const lhsRecursor =
            topIndex === -1 ? null : lhsStack[topIndex].recursor;
          const rhsRecursor =
            topIndex === -1 ? null : rhsStack[topIndex].recursor;
        ...
        if (!didFormat) {
          ...
          if (compareResult === DEEP_EQUAL) {
            ...
            if (typeof lhs.diffShallow === "function") {
              const formatter = lhs.diffShallow(
                rhs,
                themeUtils.applyModifiers(lhs, theme),
                indent
              );
              diffStack.push({
                formatter,
                ...
                exceedsMaxDepth:
                  formatter.increaseIndent &&
                  maxDepth > 0 &&
                  indent.level >= maxDepth,
                shouldFormat: formatter.shouldFormat || alwaysFormat,
              });
              diffIndex++;
              if (formatter.increaseIndent) indent = indent.increase();
            } else if (typeof lhs.formatShallow === "function") {
              const formatter = lhs.formatShallow(
                themeUtils.applyModifiers(lhs, theme),
                indent
              );
              diffStack.push({
    ...
    function diff2(actual, expected, options) {
      return diffDescriptors2(
        describe2(actual, options),
        describe2(expected, options),
        options
      );
    }
    exports.diff = diff2;
  ...
  "node_modules/concordance/lib/format.js"(exports) {
    ...
    function formatDescriptor(subject, options) {
      ...
      if (subject.isPrimitive === true) {
        const formatted = subject.formatDeep(
          themeUtils.applyModifiers(subject, theme),
          fixedIndent
        );
      ...
      do {
        if (circular.has(subject)) {
          stack[topIndex].formatter.append(
            lineBuilder.single(theme.circular),
            subject
          );
        } else {
          let didFormat = false;
...
var require_encoder = __commonJS({
  "node_modules/concordance/lib/encoder.js"(exports) {
    ...
    function encodeValue(value) {
      ...
      if (value === void 0) return valueTypes.undefined;
    ...
    function decodeValue(buffer, byteOffset) {
      ...
      byteOffset += 1;
      if (type2 === valueTypes.zero) return { byteOffset, value: 0 };
      if (type2 === valueTypes.negativeZero) return { byteOffset, value: -0 };
      if (type2 === valueTypes.notANumber) return { byteOffset, value: NaN };
      if (type2 === valueTypes.infinity) return { byteOffset, value: Infinity };
      if (type2 === valueTypes.negativeInfinity)
        return { byteOffset, value: -Infinity };
      if (type2 === valueTypes.undefined) return { byteOffset, value: void 0 };
      if (type2 === valueTypes.null) return { byteOffset, value: null };
      if (type2 === valueTypes.true) return { byteOffset, value: true };
      if (type2 === valueTypes.false) return { byteOffset, value: false };
      if (
        type2 === valueTypes.int8 ||
        type2 === valueTypes.int16 ||
        type2 === valueTypes.int24 ||
        type2 === valueTypes.int32 ||
        type2 === valueTypes.int40 ||
        type2 === valueTypes.int48
      ) {
      ...
      if (
        type2 === valueTypes.numberString ||
        type2 === valueTypes.utf8 ||
        type2 === valueTypes.bytes ||
        type2 === valueTypes.bigInt
      ) {
...
var require_serialize = __commonJS({
  "node_modules/concordance/lib/serialize.js"(exports) {
    ...
    var mappings = [
      ...
      [
        9,
        statsDescriptors.iterableTag,
        statsDescriptors.deserializeIterableStats,
      ],
      ...
      [
        ...
        statsDescriptors.deserializePropertyStats,
      ],
      [
        14,
        propertyDescriptor.complexTag,
        propertyDescriptor.deserializeComplex,
      ],
      [
        15,
        propertyDescriptor.primitiveTag,
        propertyDescriptor.deserializePrimitive,
      ],
    ...
    var id2deserialize = new Map(
      mappings.map((mapping) => [mapping[0], mapping[2]])
    );
    ...
    var MissingPluginError = class extends Error {
      constructor(pluginName) {
        super(
          `Could not deserialize buffer: missing plugin ${JSON.stringify(
            pluginName
          )}`
        );
    ...
    var PointerLookupError = class extends Error {
      constructor(index2) {
        super(
          `Could not deserialize buffer: pointer ${index2} could not be resolved`
        );
    ...
    var UnsupportedPluginError = class extends Error {
      constructor(pluginName, serializerVersion) {
        super(
          `Could not deserialize buffer: plugin ${JSON.stringify(
            pluginName
          )} expects a different serialization`
        );
    ...
    var UnsupportedVersion = class extends Error {
      ...
      constructor(serializerVersion) {
        super(
          "Could not deserialize buffer: a different serialization was expected"
        );
      ...
      if (state && state.tag) {
        ...
        if (id !== void 0) {
          const serialized = [
            pluginIndex,
            id,
            shallowSerializeDescriptor(state, resolvePluginRef),
          ];
    ...
    function serialize2(descriptor) {
      ...
      const resolvePluginRef = (tag) => {
        ...
        if (!usedPlugins.has(ref.name)) {
          ...
          usedPlugins.set(
            ref.name,
            Object.assign({ index: index2 }, ref.serialization)
          );
        }
        return {
          id: ref.id,
    ...
    function shallowDeserializeDescriptor(entry, getDescriptorDeserializer) {
      const deserializeDescriptor = getDescriptorDeserializer(
        entry[0],
        entry[1]
      );
    ...
    function deserializeRecord(record, getDescriptorDeserializer, buffer) {
      ...
      let index2 = 0;
      const recursor = () => {
        if (index2 === endIndex) return null;
        const recursorRecord = encoder.decodeRecord(
          buffer,
          record.pointerAddresses[index2++]
        );
        return deserializeRecord(
          recursorRecord,
          getDescriptorDeserializer,
          buffer
        );
      };
    ...
    function buildPluginMap(buffer, options) {
      ...
      for (const index2 of decodedPlugins.keys()) {
        ...
        if (
          serializerVersion !==
          deserializerLookup.get(pluginName).serializerVersion
        ) {
          throw new UnsupportedPluginError(pluginName, serializerVersion);
        }
        pluginMap.set(
          index2,
          deserializerLookup.get(pluginName).id2deserialize
        );
      }
      if (cache2) cache2.set(cacheKey, pluginMap);
      return pluginMap;
    }
    function deserialize(buffer, options) {
      const version2 = encoder.extractVersion(buffer);
      if (version2 !== VERSION) throw new UnsupportedVersion(version2);
      ...
      const rootDescriptor = deserializeRecord(
        decoded.rootRecord,
        getDescriptorDeserializer,
        buffer
      );
...
var require_flag = __commonJS({
  "node_modules/chai/lib/chai/utils/flag.js"(exports, module2) {
    module2.exports = function flag(obj, key, value) {
      var flags =
        obj.__flags || (obj.__flags = /* @__PURE__ */ Object.create(null));
  ...
  "node_modules/type-detect/type-detect.js"(exports, module2) {
    (function (global3, factory) {
      ...
      var setIteratorPrototype =
        setEntriesExists &&
        Object.getPrototypeOf(/* @__PURE__ */ new Set().entries());
      var mapIteratorPrototype =
        mapEntriesExists &&
        Object.getPrototypeOf(/* @__PURE__ */ new Map().entries());
  ...
  "node_modules/chai/lib/chai/utils/inspect.js"(exports, module2) {
    ...
    function inspect2(obj, showHidden, depth, colors) {
      var options = {
        ...
        showHidden,
        truncate: config2.truncateThreshold
          ? config2.truncateThreshold
          : Infinity,
      };
  ...
  "node_modules/chai/lib/chai/utils/objDisplay.js"(exports, module2) {
    ...
    module2.exports = function objDisplay2(obj) {
      var str = inspect2(obj),
        type2 = Object.prototype.toString.call(obj);
      if (
        config2.truncateThreshold &&
        str.length >= config2.truncateThreshold
      ) {
...
var require_transferFlags = __commonJS({
  "node_modules/chai/lib/chai/utils/transferFlags.js"(exports, module2) {
    module2.exports = function transferFlags(assertion, object2, includeAll) {
      var flags =
        assertion.__flags ||
        (assertion.__flags = /* @__PURE__ */ Object.create(null));
      if (!object2.__flags) {
...
var require_deep_eql = __commonJS({
  "node_modules/deep-eql/index.js"(exports, module2) {
    ...
    function memoizeCompare(leftHandOperand, rightHandOperand, memoizeMap) {
      if (
        !memoizeMap ||
        isPrimitive2(leftHandOperand) ||
        isPrimitive2(rightHandOperand)
      ) {
        return null;
      }
    ...
    function iterableEqual(leftHandOperand, rightHandOperand, options) {
      ...
      while (++index2 < length) {
        if (
          deepEqual(
            leftHandOperand[index2],
            rightHandOperand[index2],
            options
          ) === false
        ) {
          return false;
    ...
    function keysEqual(leftHandOperand, rightHandOperand, keys2, options) {
      ...
      for (var i2 = 0; i2 < length; i2 += 1) {
        if (
          deepEqual(
            leftHandOperand[keys2[i2]],
            rightHandOperand[keys2[i2]],
            options
          ) === false
        ) {
          return false;
      ...
      return new Proxy(obj, {
        get: function proxyGetter(target, property) {
          if (
            ...
            config2.proxyExcludedKeys.indexOf(property) === -1 &&
...
var require_addChainableMethod = __commonJS({
  "node_modules/chai/lib/chai/utils/addChainableMethod.js"(exports, module2) {
    ...
    module2.exports = function addChainableMethod(
      ctx,
      name,
      method,
      chainingBehavior
...
var require_overwriteChainableMethod = __commonJS({
  "node_modules/chai/lib/chai/utils/overwriteChainableMethod.js"(
    ...
    var chai3 = require_chai();
    var transferFlags = require_transferFlags();
    module2.exports = function overwriteChainableMethod(
      ctx,
      name,
      method,
      chainingBehavior
  ...
  "node_modules/check-error/index.js"(exports, module2) {
    ...
    function getConstructorName(errorLike) {
      ...
      if (errorLike instanceof Error) {
        ...
        constructorName =
          getFunctionName2(errorLike).trim() ||
          getFunctionName2(new errorLike());
      }
...
var require_utils2 = __commonJS({
  "node_modules/chai/lib/chai/utils/index.js"(exports) {
    ...
    exports.getOwnEnumerablePropertySymbols =
      require_getOwnEnumerablePropertySymbols();
...
var require_assertion = __commonJS({
  "node_modules/chai/lib/chai/assertion.js"(exports, module2) {
    ...
    module2.exports = function (_chai, util3) {
      var AssertionError2 = _chai.AssertionError,
        flag = util3.flag;
      ...
      Assertion2.overwriteChainableMethod = function (
        ...
        util3.overwriteChainableMethod(
          this.prototype,
          name,
          fn2,
          chainingBehavior
  ...
  "node_modules/chai/lib/chai/core/assertions.js"(exports, module2) {
    module2.exports = function (chai3, _) {
      var Assertion2 = chai3.Assertion,
        AssertionError2 = chai3.AssertionError,
        flag = _.flag;
      [
        "to",
        "be",
      ...
      function an(type2, msg) {
        ...
        var obj = flag(this, "object"),
          article = ~["a", "e", "i", "o", "u"].indexOf(type2.charAt(0))
            ? "an "
            : "a ";
        this.assert(
      ...
      function assertThrows(errorLike, errMsgMatcher, msg) {
        ...
        var everyArgIsUndefined =
          errorLike === void 0 && errMsgMatcher === void 0;
      ...
      function closeTo(expected, delta, msg) {
        ...
        if (typeof expected !== "number" || typeof delta !== "number") {
          flagMsg = flagMsg ? flagMsg + ": " : "";
          var deltaMessage =
            delta === void 0 ? ", and a delta is required" : "";
          throw new AssertionError2(
            flagMsg +
      ...
      function assertChanges(subject, prop, msg) {
        ...
        fn2();
        var final =
          prop === void 0 || prop === null ? subject() : subject[prop];
  ...
  "node_modules/chai/lib/chai/interface/assert.js"(exports, module2) {
    module2.exports = function (chai3, util3) {
      ...
      assert2.notStrictEqual = function (act, exp, msg) {
        new Assertion2(act, msg, assert2.notStrictEqual, true).to.not.equal(
          exp
        );
      };
      ...
      assert2.isNotFunction = function (val, msg) {
        new Assertion2(val, msg, assert2.isNotFunction, true).to.not.be.a(
          "function"
        );
      };
      ...
      assert2.isNotObject = function (val, msg) {
        new Assertion2(val, msg, assert2.isNotObject, true).to.not.be.a(
          "object"
        );
      };
      ...
      assert2.isNotArray = function (val, msg) {
        new Assertion2(val, msg, assert2.isNotArray, true).to.not.be.an(
          "array"
        );
      };
      ...
      assert2.isNotString = function (val, msg) {
        new Assertion2(val, msg, assert2.isNotString, true).to.not.be.a(
          "string"
        );
      };
      ...
      assert2.isNotNumber = function (val, msg) {
        new Assertion2(val, msg, assert2.isNotNumber, true).to.not.be.a(
          "number"
        );
      };
      ...
      assert2.isNotBoolean = function (val, msg) {
        new Assertion2(val, msg, assert2.isNotBoolean, true).to.not.be.a(
          "boolean"
        );
      };
      ...
      assert2.instanceOf = function (val, type2, msg) {
        new Assertion2(val, msg, assert2.instanceOf, true).to.be.instanceOf(
          type2
        );
      };
      ...
      assert2.notDeepInclude = function (exp, inc, msg) {
        new Assertion2(exp, msg, assert2.notDeepInclude, true).not.deep.include(
          inc
        );
      };
      assert2.nestedInclude = function (exp, inc, msg) {
        new Assertion2(exp, msg, assert2.nestedInclude, true).nested.include(
          inc
        );
      };
      ...
      assert2.notOwnInclude = function (exp, inc, msg) {
        new Assertion2(exp, msg, assert2.notOwnInclude, true).not.own.include(
          inc
        );
      };
      assert2.deepOwnInclude = function (exp, inc, msg) {
        new Assertion2(exp, msg, assert2.deepOwnInclude, true).deep.own.include(
          inc
        );
      };
      ...
      assert2.propertyVal = function (obj, prop, val, msg) {
        new Assertion2(obj, msg, assert2.propertyVal, true).to.have.property(
          prop,
          val
        );
      };
      ...
      assert2.hasAnyKeys = function (obj, keys2, msg) {
        new Assertion2(obj, msg, assert2.hasAnyKeys, true).to.have.any.keys(
          keys2
        );
      };
      assert2.hasAllKeys = function (obj, keys2, msg) {
        new Assertion2(obj, msg, assert2.hasAllKeys, true).to.have.all.keys(
          keys2
        );
      };
      ...
      assert2.throws = function (fn2, errorLike, errMsgMatcher, msg) {
        ...
        var assertErr = new Assertion2(fn2, msg, assert2.throws, true).to.throw(
          errorLike,
          errMsgMatcher
        );
      ...
      assert2.doesNotThrow = function (fn2, errorLike, errMsgMatcher, msg) {
        ...
        new Assertion2(fn2, msg, assert2.doesNotThrow, true).to.not.throw(
          errorLike,
          errMsgMatcher
        );
      };
      ...
      assert2.closeTo = function (act, exp, delta, msg) {
        new Assertion2(act, msg, assert2.closeTo, true).to.be.closeTo(
          exp,
          delta
        );
      };
      ...
      assert2.changesBy = function (fn2, obj, prop, delta, msg) {
        ...
        new Assertion2(fn2, msg, assert2.changesBy, true).to
          .change(obj, prop)
          .by(delta);
      };
      ...
      assert2.changesButNotBy = function (fn2, obj, prop, delta, msg) {
        ...
        new Assertion2(fn2, msg, assert2.changesButNotBy, true).to
          .change(obj, prop)
          .but.not.by(delta);
      };
      assert2.increases = function (fn2, obj, prop, msg) {
        ...
        return new Assertion2(fn2, msg, assert2.increases, true).to.increase(
          obj,
          prop
        );
      };
      assert2.increasesBy = function (fn2, obj, prop, delta, msg) {
        ...
        new Assertion2(fn2, msg, assert2.increasesBy, true).to
          .increase(obj, prop)
          .by(delta);
      };
      ...
      assert2.increasesButNotBy = function (fn2, obj, prop, delta, msg) {
        ...
        new Assertion2(fn2, msg, assert2.increasesButNotBy, true).to
          .increase(obj, prop)
          .but.not.by(delta);
      };
      assert2.decreases = function (fn2, obj, prop, msg) {
        ...
        return new Assertion2(fn2, msg, assert2.decreases, true).to.decrease(
          obj,
          prop
        );
      };
      assert2.decreasesBy = function (fn2, obj, prop, delta, msg) {
        ...
        new Assertion2(fn2, msg, assert2.decreasesBy, true).to
          .decrease(obj, prop)
          .by(delta);
      };
      ...
      assert2.doesNotDecreaseBy = function (fn2, obj, prop, delta, msg) {
        ...
        return new Assertion2(fn2, msg, assert2.doesNotDecreaseBy, true).to.not
          .decrease(obj, prop)
          .by(delta);
      };
      assert2.decreasesButNotBy = function (fn2, obj, prop, delta, msg) {
        ...
        new Assertion2(fn2, msg, assert2.decreasesButNotBy, true).to
          .decrease(obj, prop)
          .but.not.by(delta);
      };
      ...
      assert2.isNotExtensible = function (obj, msg) {
        new Assertion2(obj, msg, assert2.isNotExtensible, true).to.not.be
          .extensible;
      };
...
// node_modules/@vitest/snapshot/node_modules/pretty-format/build/plugins/ConvertAnsi.js
var require_ConvertAnsi2 = __commonJS({
  "node_modules/@vitest/snapshot/node_modules/pretty-format/build/plugins/ConvertAnsi.js"(
    exports
  ) {
    "use strict";
...
// node_modules/@vitest/snapshot/node_modules/react-is/cjs/react-is.production.min.js
...
// node_modules/@vitest/snapshot/node_modules/react-is/cjs/react-is.development.js
...
// node_modules/@vitest/snapshot/node_modules/react-is/index.js
...
var require_build2 = __commonJS({
  "node_modules/@vitest/snapshot/node_modules/pretty-format/build/index.js"(
    ...
    var _ConvertAnsi = _interopRequireDefault(require_ConvertAnsi2());
  ...
  "node_modules/magic-string/dist/magic-string.es.mjs"() {
    ...
    MagicString = class {
      ...
      _replaceAllString(string3, replacement) {
        ...
        const stringLength = string3.length;
        for (
          let index2 = original.indexOf(string3);
          index2 !== -1;
          index2 = original.indexOf(string3, index2 + stringLength)
        ) {
    ...
    Bundle = class {
      constructor(options = {}) {
        ...
        this.separator =
          options.separator !== void 0 ? options.separator : "\n";
        this.sources = [];
        this.uniqueSources = [];
      ...
      getIndentString() {
        ...
        return (
          Object.keys(indentStringCounts).sort((a, b2) => {
      ...
      indent(indentStr) {
        ...
        this.sources.forEach((source, i2) => {
          const separator =
            source.separator !== void 0 ? source.separator : this.separator;
          const indentStart =
            trailingNewline || (i2 > 0 && /\r?\n$/.test(separator));
...
// src/tests/units-tests/use-cases/admin/UpdateUserPermissionsUseCase.spec.ts
...
function collectOwnProperties(obj, collector) {
  const collect =
    typeof collector === "function" ? collector : (key) => collector.add(key);
...
function stringify(object2, maxDepth = 10, { maxLength, ...options } = {}) {
  ...
  return result.length >= MAX_LENGTH && maxDepth > 1
    ? stringify(object2, Math.floor(maxDepth / 2))
    : result;
}
var loupe =
  typeof loupe_default.default === "function"
    ? loupe_default.default
    : loupe_default;
...
string.open = "";
string.close = "";
var defaultColors = /* @__PURE__ */ colorsEntries.reduce(
  (acc, [key]) => {
    acc[key] = string;
    return acc;
  },
...
function getSafeTimers() {
  ...
  const { nextTick: safeNextTick } = globalThis[SAFE_TIMERS_SYMBOL] ||
...
var resolve = function (...arguments_) {
  ...
  for (
    let index2 = arguments_.length - 1;
...
var concordance = __toESM(require_concordance(), 1);
var concordanceModule =
  "default" in concordance ? concordance.default : concordance;
...
function unifiedDiff(actual, expected, options = {}) {
  ...
  lines.forEach((line) => {
    if (line.startsWith(plus)) counts["+"]++;
    else if (line.startsWith(minus)) counts["-"]++;
  });
...
`;
  ...
  return legend + diff2.replace(/␊\s*$/gm, "");
}
...
function processError(err, options = {}) {
  ...
  if (err.stack) err.stackStr = String(err.stack);
  if (err.name) err.nameStr = String(err.name);
  ...
  if (typeof err.actual !== "string") err.actual = stringify(err.actual, 10);
  try {
  ...
  try {
    ...
    return serializeError(
      new Error(`Failed to fully serialize error: ${
...
function getNames(task) {
  ...
  let current = task;
  while (
    (current == null ? void 0 : current.suite) ||
    (current == null ? void 0 : current.file)
  ) {
...
var dirname = function (p) {
  const segments = normalizeWindowsPath2(p)
    .replace(/\/$/, "")
    .split("/")
    .slice(0, -1);
...
function withTimeout(fn2, timeout, isHook = false) {
  if (timeout <= 0 || timeout === Infinity) return fn2;
...
function createTestContext(test3, runner2) {
  ...
  return (
    ((_a2 = runner2.extendTestContext) == null
      ? void 0
      : _a2.call(runner2, context)) || context
  );
}
...
var test = createTest(function (name, fn2, options) {
...
function createSuiteCollector(
  ...
  const test22 = createTest(function (name2, fn2 = noop, options) {
    ...
    if (this.concurrent || concurrent) test3.concurrent = true;
    if (shuffle2) test3.shuffle = true;
  ...
  async function collect(file) {
    factoryQueue.length = 0;
    if (factory) await runWithSuite(collector, () => factory(test22));
    const allChildren = [];
  ...
  suiteFn.each = function (cases, ...args) {
    ...
    return (name, fn2, options) => {
      ...
      cases.forEach((i2, idx) => {
        ...
        arrayOnlyCases
          ? suite2(formatTitle(_name, items, idx), () => fn2(...items), options)
          : suite2(formatTitle(_name, items, idx), () => fn2(i2), options);
      });
    ...
    return (name, fn22, options) => {
      ...
      cases.forEach((i2, idx) => {
        ...
        arrayOnlyCases
          ...
          : test22(formatTitle(_name, items, idx), () => fn22(i2), options);
      });
      this.setContext("each", void 0);
    };
  };
    ...
    formatted = formatted.replace(
      ...
      (_, key) => {
        ...
        return objDisplay(
          ...
          (_a2 = runner == null ? void 0 : runner.config) == null
            ? void 0
            : _a2.chaiConfig
        );
      }
...
function beforeAll(fn2, timeout) {
  return getCurrentSuite().on(
    "beforeAll",
    withTimeout(fn2, timeout ?? getDefaultHookTimeout(), true)
  );
}
...
var isNode =
  ...
  !((_a = process.versions) == null ? void 0 : _a.deno) &&
  !globalThis.window;
...
function resetModules(modules, resetMocks = false) {
  ...
  modules.forEach((mod, path3) => {
    if (skipPaths.some((re) => re.test(path3))) return;
...
function I(e) {
  ...
  let t = function (...o) {
    ...
    if (((n2.called = true), n2.callCount++, n2.calls.push(o), n2.next)) {
      let [p, s] = n2.next;
      if ((n2.results.push(n2.next), (n2.next = null), p === "ok")) return s;
      throw s;
    }
    let a,
      d = "ok";
  ...
  l(t, "_isMockFunction", true),
    l(t, "length", e ? e.length : 0),
    l(t, "name", (e && e.name) || "spy");
  let r = A(t);
  return r.reset(), (r.impl = e), t;
}
var P = (e, t) => Object.getOwnPropertyDescriptor(e, t);
function E(e, t, r) {
  g(!i("undefined", e), "spyOn could not find an object to spy upon"),
    g(i("object", e) || i("function", e), "cannot spyOn on a primitive value");
  let o = () => {
      if (!i("object", t)) return [t, "value"];
  ...
  a === "value" &&
    ...
    !s.value &&
    s.get &&
    ((a = "get"), (w = true), (r = s.get()));
  let c;
  s ? (c = s[a]) : a !== "value" ? (c = () => e[n2]) : (c = e[n2]),
    r || (r = c);
  let x = I(r),
    O = (h) => {
      let { value: G, ...k } = s || {
  ...
  return (
    l(T, "restore", K),
    l(T, "getOriginal", () => (w ? c() : c)),
    l(T, "willCall", (h) => ((T.impl = h), x)),
    O(w ? () => x : x),
    m.add(x),
    x
  );
...
function isMockFunction(fn2) {
  return (
    typeof fn2 === "function" && "_isMockFunction" in fn2 && fn2._isMockFunction
  );
}
...
function enhanceSpy(spy) {
  ...
  stub.mockResolvedValue = (val) =>
    stub.mockImplementation(() => Promise.resolve(val));
  stub.mockResolvedValueOnce = (val) =>
    stub.mockImplementationOnce(() => Promise.resolve(val));
  stub.mockRejectedValue = (val) =>
    stub.mockImplementation(() => Promise.reject(val));
  stub.mockRejectedValueOnce = (val) =>
...
function getMatcherUtils() {
  ...
  const printReceived = (object2) =>
    RECEIVED_COLOR(replaceTrailingSpaces(stringify(object2)));
...
function asymmetricMatch(a, b2) {
  ...
  if (asymmetricA && asymmetricB) return void 0;
...
function eq(a, b2, aStack, bStack, customTesters, hasKey2) {
  ...
  if (className2 !== Object.prototype.toString.call(b2)) return false;
  switch (className2) {
    case "[object Boolean]":
    case "[object String]":
    case "[object Number]":
  ...
  while (length--) {
    ...
    else if (bStack[length] === b2) return false;
  }
  aStack.push(a);
  bStack.push(b2);
  if (className2 === "[object Array]" && a.length !== b2.length) return false;
  ...
  while (size--) {
    ...
    result =
      hasKey2(b2, key) &&
      eq(a[key], b2[key], aStack, bStack, customTesters, hasKey2);
...
function keys(obj, hasKey2) {
  ...
  for (const key in obj) {
    if (hasKey2(obj, key)) keys2.push(key);
  }
  return keys2.concat(
...
function iterableEquality(a, b2, aStack = [], bStack = []) {
  ...
  aStack.push(a);
  bStack.push(b2);
  const iterableEqualityWithStack = (a2, b22) =>
    iterableEquality(a2, b22, [...aStack], [...bStack]);
  if (a.size !== void 0) {
    if (a.size !== b2.size) {
      return false;
      ...
      for (const aEntry of a) {
        if (
          !b2.has(aEntry[0]) ||
          !equals(aEntry[1], b2.get(aEntry[0]), [iterableEqualityWithStack])
        ) {
          let has2 = false;
          for (const bEntry of b2) {
            ...
            if (matchedValue === true) has2 = true;
          }
          if (has2 === false) {
            allFound = false;
            break;
...
function hasPropertyInObject(object2, key) {
  const shouldTerminate =
    !object2 || typeof object2 !== "object" || object2 === Object.prototype;
  if (shouldTerminate) return false;
  return (
    Object.prototype.hasOwnProperty.call(object2, key) ||
    hasPropertyInObject(Object.getPrototypeOf(object2), key)
  );
}
...
function subsetEquality(object2, subset) {
  const subsetEqualityWithContext =
    ...
    (object22, subset2) => {
      if (!isObjectWithKeys(subset2)) return void 0;
      return Object.keys(subset2).every((key) => {
        ...
        const result =
          object22 != null &&
          hasPropertyInObject(object22, key) &&
          equals(object22[key], subset2[key], [
            iterableEquality,
...
function arrayBufferEquality(a, b2) {
  ...
  for (let i2 = 0; i2 < dataViewA.byteLength; i2++) {
    if (dataViewA.getUint8(i2) !== dataViewB.getUint8(i2)) return false;
  }
  return true;
}
function sparseArrayEquality(a, b2) {
  if (!Array.isArray(a) || !Array.isArray(b2)) return void 0;
  const aKeys = Object.keys(a);
  const bKeys = Object.keys(b2);
  return (
    equals(a, b2, [iterableEquality, typeEquality], true) &&
    equals(aKeys, bKeys)
  );
}
...
var Any = class extends AsymmetricMatcher2 {
  ...
  fnNameFor(func) {
    ...
    const matches = functionToString2
      .call(func)
...
function recordAsyncExpect(test3, promise) {
  if (test3 && promise instanceof Promise) {
    promise = promise.finally(() => {
      ...
      if (index2 !== -1) test3.promises.splice(index2, 1);
    });
    if (!test3.promises) test3.promises = [];
...
function wrapSoft(utils, fn2) {
  return function (...args) {
    ...
    const state = (test3 == null ? void 0 : test3.context._local)
      ? test3.context.expect.getState()
      : getState(globalThis[GLOBAL_EXPECT]);
    if (!state.soft) return fn2.apply(this, args);
...
var JestChaiExpect = (chai3, utils) => {
  ...
  function def(name, fn2) {
    ...
    if (Array.isArray(name)) name.forEach((n2) => addMethod(n2));
    else addMethod(name);
  }
  ...
  const ordinalOf = (i2) => {
    const j = i2 % 10;
    const k = i2 % 100;
    if (j === 1 && k !== 11) return `${i2}st`;
    if (j === 2 && k !== 12) return `${i2}nd`;
    if (j === 3 && k !== 13) return `${i2}rd`;
    return `${i2}th`;
  };
...
${spy.mock.calls
  .map((callArg, i2) => {
    let methodCall = c().bold(`    ${ordinalOf(
      i2 + 1
    )} ${spy.getMockName()} call:
...
`);
  ...
  def(["toHaveBeenCalledWith", "toBeCalledWith"], function (...args) {
    ...
    const pass = spy.mock.calls.some((callArg) =>
      equals(callArg, args, [iterableEquality])
    );
    const isNot = utils.flag(this, "negate");
    let msg = utils.getMessage(this, [
      pass,
  ...
  def(["toHaveReturned", "toReturn"], function () {
    const spy = getSpy(this);
    const spyName = spy.getMockName();
    const calledAndNotThrew =
      spy.mock.calls.length > 0 &&
      spy.mock.results.some(({ type: type2 }) => type2 !== "throw");
    this.assert(
      calledAndNotThrew,
  ...
  def(["toHaveReturnedTimes", "toReturnTimes"], function (times) {
    const spy = getSpy(this);
    const spyName = spy.getMockName();
    const successfulReturns = spy.mock.results.reduce(
      (success, { type: type2 }) => (type2 === "throw" ? success : ++success),
      0
    );
    this.assert(
  ...
  def(["toHaveReturnedWith", "toReturnWith"], function (value) {
    const spy = getSpy(this);
    const spyName = spy.getMockName();
    const pass = spy.mock.results.some(
      ({ type: type2, value: result }) =>
        type2 === "return" && equals(value, result)
    );
    const isNot = utils.flag(this, "negate");
    let msg = utils.getMessage(this, [
      pass,
        ...
        get: (target, key, receiver) => {
          ...
          return async (...args) => {
            const promise = obj.then(
              ...
              (err) => {
                throw new Error(
                  `promise rejected "${String(err)}" instead of resolving`
                );
              }
            );
        ...
        get: (target, key, receiver) => {
          ...
          return async (...args) => {
            const promise = wrapper.then(
              (value) => {
                throw new Error(
                  `promise resolved "${String(value)}" instead of rejecting`
                );
              },
              (err) => {
...
var import_pretty_format4 = __toESM(require_build2(), 1);
...
var resolve3 = function (...arguments_) {
  ...
  for (
    ...
    const path3 = index2 >= 0 ? arguments_[index2] : cwd2();
    if (!path3 || path3.length === 0) {
      continue;
    }
    resolvedPath = `${path3}/${resolvedPath}`;
    resolvedAbsolute = isAbsolute3(path3);
  }
...
function normalizeString3(path3, allowAboveRoot) {
  let res = "";
  let lastSegmentLength = 0;
  let lastSlash = -1;
  let dots = 0;
...
function positionToOffset(source, lineNumber, columnNumber) {
  ...
  for (let i2 = 0; i2 < lineNumber - 1; i2++) start += lines[i2].length + nl;
...
function serialize(val, indent = 2, formatOverrides = {}) {
  return normalizeNewlines(
    (0, import_pretty_format4.format)(val, {
      escapeRegex,
      indent,
...
function prepareExpected(expected) {
  function findStartIndent() {
    ...
    const objectIndent =
      (_a2 = matchObject == null ? void 0 : matchObject[1]) == null
        ? void 0
        : _a2.length;
...
async function saveInlineSnapshots(environment, snapshots) {
  const MagicString2 = (
    await Promise.resolve().then(
      () => (init_magic_string_es(), magic_string_es_exports)
    )
  ).default;
...
function replaceObjectSnap(code, s, index2, newSnap) {
  ...
  s.appendLeft(
    index2 + startMatch.index + charIndex,
    `, ${prepareSnapString(newSnap, code, index2)}`
  );
  return true;
}
...
function replaceInlineSnap(code, s, index2, newSnap) {
  ...
  if (!startMatch) return replaceObjectSnap(code, s, index2, newSnap);
...
var SnapshotState = class {
  ...
  _inferInlineSnapshotStack(stacks) {
    const promiseIndex = stacks.findIndex((i2) =>
      i2.method.match(/__VITEST_(RESOLVES|REJECTS)__/)
    );
    if (promiseIndex !== -1) return stacks[promiseIndex + 3];
    const stackIndex = stacks.findIndex((i2) =>
      i2.method.includes("__INLINE_SNAPSHOT__")
    );
...
var SnapshotClient = class {
  ...
  async setTest(filepath, name, options) {
    ...
    this.name = name;
    if (
      ((_a2 = this.snapshotState) == null ? void 0 : _a2.testFilePath) !==
      filepath
    ) {
      this.resetCurrent();
  ...
  skipTestSnapshots(name) {
    var _a2;
    (_a2 = this.snapshotState) == null
      ? void 0
      : _a2.markSnapshotsAsCheckedForTest(name);
  }
  /**
...
// node_modules/vitest/dist/vendor-vi.55d2bc52.js
...
function createBenchmark(fn2) {
  const benchmark = createChainable(["skip", "only", "todo"], fn2);
...
function getSnapshotClient() {
  if (!_client) _client = new VitestSnapshotClient();
  return _client;
}
...
var SnapshotPlugin = (chai3, utils) => {
  ...
  utils.addMethod(
    ...
    function __INLINE_SNAPSHOT__(properties, inlineSnapshot, message) {
      ...
      const isInsideEach =
        test3 &&
        (test3.each || ((_a2 = test3.suite) == null ? void 0 : _a2.each));
      if (isInsideEach)
        throw new Error(
...
function createExpect(test3) {
  ...
  const expect2 = (value, message) => {
    ...
    if (_test2) return assert2.withTest(_test2);
    else return assert2;
  };
  ...
  setState(
    {
      ...
      testPath: test3
        ? (_a2 = test3.suite.file) == null
          ? void 0
          : _a2.filepath
        : globalState.testPath,
    ...
    const errorGen = () =>
      new Error(
        `expected number of assertions to be ${expected}, but got ${
          expect2.getState().assertionCalls
        }`
      );
    if (Error.captureStackTrace)
...
function className(value) {
  return (
    (value.constructor && value.constructor.name) || // The next branch is for IE11 support only:
    ...
    (typeof value.constructor === "function" /* istanbul ignore next */ &&
      functionName2(value.constructor)) ||
    null
  );
}
  ...
  return {
    ...
    mock(path3, factory) {
      ...
      _mocker.queueMock(
        ...
        importer,
        factory
          ? () => factory(() => _mocker.importActual(path3, importer))
          : void 0
      );
    },
    unmock(path3) {
    ...
    doMock(path3, factory) {
      _mocker.queueMock(path3, getImporter(), factory);
    },
    doUnmock(path3) {
      _mocker.queueUnmock(path3, getImporter());
    },
    async importActual(path3) {
      return _mocker.importActual(path3, getImporter());
    },
...
function runOnce(fn2, key) {
  ...
  if (!cache.has(id)) cache.set(id, fn2());
  return cache.get(id);
}
function isFirstRun() {
  let firstRun = false;
...
// node_modules/vitest/dist/vendor-index.b46c103a.js
...
var DatabaseRepository = class {
  ...
  async persist() {
    const databasePath = import_node_path.default.join(__dirname, "./db.json");
    console.log("AQUI", this._database);
    await import_promises.default.writeFile(
      databasePath,
      JSON.stringify(this._database)
    );
  }
  _updateLastId() {
...
describe("Delete User", () => {
  ...
  it("should able to update a user", async () => {
    ...
    globalExpect(beforeUpdate?.isAdmin).not.toBeTruthy();
    globalExpect(beforeUpdate?.permissions.canUpdate).not.toBeTruthy();
    globalExpect(beforeUpdate?.permissions.canDelete).not.toBeTruthy();
    const newUserData = {
      isAdmin: true,
      permissions: {
        canUpdate: true,
    ...
    globalExpect(afterUpdate).toEqual(
      globalExpect.objectContaining({
        id: globalExpect.any(Number),
        name: createdUser.name,
        password: globalExpect.any(String),
        isAdmin: true,
        permissions: {
          canUpdate: true,
          canDelete: true,
