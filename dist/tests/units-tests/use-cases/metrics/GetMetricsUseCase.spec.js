...
// src/tests/units-tests/use-cases/metrics/GetMetricsUseCase.spec.ts
...
describe("Get Users", () => {
  ...
  it("should able to get all metrics list", async () => {
    ...
    globalExpect(metrics).toHaveLength(2);
    globalExpect(metrics).toEqual(
      globalExpect.arrayContaining([
        {
          id: 1,
          readCount: 2,
        },
