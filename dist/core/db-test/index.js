...
// src/core/db-test/index.ts
var db_test_exports = {};
__export(db_test_exports, {
  DatabaseTestRepository: () => DatabaseTestRepository
});
module.exports = __toCommonJS(db_test_exports);
var import_promises = __toESM(require("fs/promises"));
var import_node_path = __toESM(require("path"));
var import_tsyringe = require("tsyringe");
var DatabaseTestRepository = class {
  constructor() {
  ...
  async persist() {
    const databasePath = import_node_path.default.join(__dirname, "./db-test.json");
...
DatabaseTestRepository = __decorateClass([
  (0, import_tsyringe.injectable)()
], DatabaseTestRepository);
