...
async function AuthenticateUserController(req, res, next) {
  ...
  try {
    const authenticateUserUseCase = import_tsyringe3.container.resolve(AuthenticateUserUseCase);
...
async function CreateUserController(req, res, next) {
  ...
  try {
    const createUserUseCase = import_tsyringe5.container.resolve(CreateUserUseCase);
...
async function DeleteUserController(req, res) {
  ...
  try {
    const deleteUserUseCase = import_tsyringe7.container.resolve(DeleteUserUseCase);
...
async function GetMetricsController(req, res) {
  try {
    const getMetricsUseCase = import_tsyringe9.container.resolve(GetMetricsUseCase);
...
async function GetUserController(req, res) {
  ...
  try {
    const getUserUseCase = import_tsyringe11.container.resolve(GetUserUseCase);
...
async function GetUsersController(req, res) {
  try {
    const getUsersUseCase = import_tsyringe13.container.resolve(GetUsersUseCase);
...
async function UpdateUserPermissionsController(req, res) {
  ...
  try {
    const updateUserPermissionsUseCase = import_tsyringe15.container.resolve(
      UpdateUserPermissionsUseCase
    );
